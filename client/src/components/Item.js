    ...
    return (
        <>
            <div className="card text-bg-dark my-3">
                <img src={imageUrl ? imageUrl : "placeholder_product.jpg"} className="card-img-top" alt="..." />
                ...
                <div className="card-body">
                    ...
                    <div className="d-flex justify-content-center" style={{gap:"2vh"}}>
                        ...
                        {inCart && <button className="btn btn-md btn-primary" onClick={handleDecrementProduct}>-</button>}
                        {inCart && <p className="card-text">{products[i].itemQuantity}</p>}
                        {inCart && <button className="btn btn-md btn-primary" onClick={handleAddProduct}>+</button>}
                    </div>
                </div>
            </div>
        </>
